...
parser.add_argument("--log_dir", type=str, default='/raid/Final_diffusion/logs/Sevir/5to5/D20250101T0049', help="Where to save logs of the model.")
parser.add_argument("--ori_log_dir", type=str, default='/raid/Final_diffusion/logs/Sevir/5to5/D20250101T0049', help="Where to save logs of the model.")
...
for step, (frames, diff_frames) in enumerate(dataloader):
    ...
    generated_images = diffusion_ori.sample(frames[:args.batch_size, :args.cond_dim, :, :], batch_size=args.batch_size)
